package com.cn.developer.xgdemo;
...
import com.cn.developer.xgdemo.cloud.ClickAction;
import com.cn.developer.xgdemo.cloud.Style;
import com.cn.developer.xgdemo.cloud.TimeInterval;
import com.cn.developer.xgdemo.cloud.XingeApp;
import com.cn.developer.xgdemo.common.CommonWorkingThread;
import com.cn.developer.xgdemo.common.ExtendedListView;
import com.cn.developer.xgdemo.common.ExtendedListView.OnPositionChangedListener;
...
//			Toast.makeText(this, "通知被点击:"+accID,
//					Toast.LENGTH_SHORT).show();
//			Toast.makeText(this, "通知被点击:"+secretKey,
//					Toast.LENGTH_SHORT).show();
//		}catch (Exception e)
//		{
//
//		}
	...
	private void step7() {
		...
		try {
			com.cn.developer.xgdemo.cloud.Message message = new com.cn.developer.xgdemo.cloud.Message();
			message.setType(com.cn.developer.xgdemo.cloud.Message.TYPE_NOTIFICATION);
//			String secretKey = (String) getMetaData(getApplicationContext(), "XG_V2_SECRET_KEY", "");
//			long accID = (Integer) getMetaData(getApplicationContext(), "XG_V2_ACCESS_ID", "0");
//			Toast.makeText(this, "通知被点击:"+accID,
//					Toast.LENGTH_SHORT).show();
...
//					Toast.LENGTH_SHORT).show();
			...
			updateProgress((System.currentTimeMillis() - timeMillis) + "ms 返回值解析!"+ret.toString());
